        ...
        <div class="owl-carousel owl-banner">
          <div class="item item-1">
            <div class="header-text">
              <span class="category">Halo Sobat Pedia</span>
              <h2>Laboratorium Pendidikan Multimedia</h2>
              <p>Lorem ipsum dolor sit amet consectetur. At integer sit nisl cursus tincidunt pellentesque. Faucibus aliquet leo ipsum morbi neque elementum rhoncus purus enim. </p>
              <div class="buttons">
                <div class="main-button">
                  <a href="#">Request Demo</a>
                </div>
                <div class="icon-button">
                  <a href="#"><i class="fa fa-play"></i> Apa itu SIMLT</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        <div class="section-heading">
          <h6> Layanan</h6>
          <h2 class="font-weight-normal mb-0">Laboratorium Pendidikan Multimedia</h2>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="service-item">
          <div class="icon">
            <img src="{{asset('vendor/assets2/assets/images/service-01.png')}}" alt="online degrees">
          </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item">
          <div class="icon">
            <img src="{{asset('vendor/assets2/assets/images/service-02.png')}}" alt="short courses">
          </div>
          <div class="main-content">
            <h4>Praktikum</h4>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item">
          <div class="icon">
            <img src="{{asset('vendor/assets2/assets/images/service-03.png')}}" alt="web experts">
          </div>
          <div class="main-content">
            <h4>Lab dan alat Lab</h4>
            <p>Peminjaman lab dan peralatan lab yang mendukung proses pembelajaran.</p>
            <div class="main-button">
              <a href="#">Read More</a>
            </div>
          </div>
    ...
    <div class="row event_box">
      <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
        <div class="events_item">
          <div class="thumb">
            <a href="#"><img src="{{asset('vendor/assets2/assets/images/course-01.jpg')}}" alt=""></a>
      ...
      <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
        <div class="events_item">
          <div class="thumb">
            <a href="#"><img src="{{asset('vendor/assets2/assets/images/course-02.jpg')}}" alt=""></a>
      ...
      <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
        <div class="events_item">
          <div class="thumb">
            <a href="#"><img src="{{asset('vendor/assets2/assets/images/course-03.jpg')}}" alt=""></a>
      ...
      <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
        <div class="events_item">
          <div class="thumb">
            <a href="#"><img src="{{asset('vendor/assets2/assets/images/course-04.jpg')}}" alt=""></a>
            <span class="category">Development</span>
            <span class="price">
              <h6><em>$</em>450</h6>
            </span>
      ...
      <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
        <div class="events_item">
          <div class="thumb">
            <a href="#"><img src="{{asset('vendor/assets2/assets/images/course-05.jpg')}}" alt=""></a>
            <span class="category">Wordpress</span>
            <span class="price">
              <h6><em>$</em>320</h6>
            </span>
      ...
      <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
        <div class="events_item">
          <div class="thumb">
            <a href="#"><img src="{{asset('vendor/assets2/assets/images/course-06.jpg')}}" alt=""></a>
            <span class="category">Webdesign</span>
            <span class="price">
              <h6><em>$</em>240</h6>
            </span>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6">
        <div class="team-member">
          <div class="main-content">
            <img src="{{asset('vendor/assets2/assets/images/member-01.jpg')}}" alt="">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="team-member">
          <div class="main-content">
            <img src="{{asset('vendor/assets2/assets/images/member-02.jpg')}}" alt="">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="team-member">
          <div class="main-content">
            <img src="{{asset('vendor/assets2/assets/images/member-03.jpg')}}" alt="">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="team-member">
          <div class="main-content">
            <img src="{{asset('vendor/assets2/assets/images/member-04.jpg')}}" alt="">
      ...
      <div class="col-lg-7">
        <div class="owl-carousel owl-testimonials">
          <div class="item">
            ...
            <div class="author">
              <img src="{{asset('vendor/assets2/assets/images/testimonial-author.jpg')}}" alt="">
              <span class="category">Full Stack Master</span>
              <h4>Claude David</h4>
            </div>
          </div>
      ...
      <div class="col-lg-12 col-md-6">
        <div class="item">
          <div class="row">
            <div class="col-lg-3">
              <div class="image">
                <img src="{{asset('vendor/assets2/assets/images/event-01.jpg')}}" alt="">
              </div>
            </div>
            <div class="col-lg-9">
              <ul>
      ...
      <div class="col-lg-12 col-md-6">
        <div class="item">
          <div class="row">
            <div class="col-lg-3">
              <div class="image">
                <img src="{{asset('vendor/assets2/assets/images/event-02.jpg')}}" alt="">
              </div>
            </div>
            <div class="col-lg-9">
              <ul>
      ...
      <div class="col-lg-12 col-md-6">
        <div class="item">
          <div class="row">
            <div class="col-lg-3">
              <div class="image">
                <img src="{{asset('vendor/assets2/assets/images/event-03.jpg')}}" alt="">
              </div>
            </div>
            <div class="col-lg-9">
              <ul>
